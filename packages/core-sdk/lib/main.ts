...
import { blockchainOfflineConnectors, blockchainWalletConnectors } from '@root/config'
import {
  CloudflareConnector,
  IConnector,
  MathWalletConnector,
...
import { Blockchains, Connectors, WalletConnectors, OfflineConnectors } from '@root/Types'
...
export const getBlockchainOfflineConnectors = getBlockchainConnectors('offline')
