...
export const getTooltipBodyByPlacement = (
  placement: string,
  tooltipAttributes: {
    style: Properties;
    content: React.ReactNode;
  ...
  switch (placement) {
    case "top":
      return <TopTooltipBody {...props}>{content}</TopTooltipBody>;
    case "top-start":
      return <TopStartTooltipBody {...props}>{content}</TopStartTooltipBody>;
    case "top-end":
      return <TopEndTooltipBody {...props}>{content}</TopEndTooltipBody>;
    case "bottom":
      return <BottomTooltipBody {...props}>{content}</BottomTooltipBody>;
    case "bottom-start":
      return (
        <BottomStartTooltipBody {...props}>{content}</BottomStartTooltipBody>
      );
    case "bottom-end":
      return <BottomEndTooltipBody {...props}>{content}</BottomEndTooltipBody>;
    case "right":
      return <RightTooltipBody {...props}>{content}</RightTooltipBody>;
    case "right-start":
      return (
        <RightStartTooltipBody {...props}>{content}</RightStartTooltipBody>
      );
    case "right-end":
      return <RightEndTooltipBody {...props}>{content}</RightEndTooltipBody>;
    case "left":
      return <LeftTooltipBody {...props}>{content}</LeftTooltipBody>;
    case "left-start":
      return <LeftStartTooltipBody {...props}>{content}</LeftStartTooltipBody>;
    case "left-end":
      return <LeftEndTooltipBody {...props}>{content}</LeftEndTooltipBody>;
  }
