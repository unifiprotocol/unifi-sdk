...
import { Transfer } from "./Contracts/ERC20/transfer";
...
export const Sample: ShellWrappedComp = ({ connection, eventBus }) => {
  ...
  const sendTransaction = useCallback(async () => {
    ...
    const useCase = new Transfer({
      tokenAddress: address,
      recipient: "0x7e3944CBC535766671bf962c3e796540f6007F1e",
      amount: "1000",
    });
  ...
  return (
    <div>
      ...
      <div>
        <PrimaryButton onClick={sendTransaction}>Send trx</PrimaryButton>
      </div>
